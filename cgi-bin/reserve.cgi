...
<table border="0" width="968" id="table1" height="647" cellspacing="0">
	<tr>
		<td background="../../images/head_bg.gif" height="110" width="962" colspan="3">
		<table border="0" width="100%" id="table2" height="108">
			<tr>
				<td rowspan="3" width="424" align="left" valign="bottom">
				<img border="0" src="../../images/logo.jpg" width="367" height="82"></td>
				<td height="2"></td>
			</tr>
			<tr>
				<td height="45" align="right" valign="top"><b>
				<font face="Arial" color="#820000">CONTACT&nbsp; US</font></b></td>
			</tr>
			<tr>
				<td width="528" height="34" align="right" valign="top">
				<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" id="obj5" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" border="0" width="86" height="22">
					<param name="movie" value="../../flash/Spain.swf">
					<param name="quality" value="High">
					<embed src="../../flash/Spain.swf" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" name="obj5" width="86" height="22" quality="High"></object>
				</td>
			</tr>
		</table>
		</td>
	...
	<tr>
		<td width="143" height="52">
		<img border="0" src="../../images/blank.gif" width="50" height="50"></td>
		<td width="6" rowspan="2">&nbsp;</td>
		<td width="805" rowspan="2" height="500">
		<p align="center">
		<center>
   <table border=0 width=465>
    <tr><th>
		<p align="left"><font size=+2 face="Arial" color="#808080">Error: Blank Fields</font></th></tr>
   </table>
   <table border=0 width=465>
    <tr><td><font face="Arial" size="2">The following fields were left blank in your submission form:</font><p>
     <ul>
<font face="Arial" size="2">$missing_field_list
     </font>
     </ul><font face="Arial" size="2"><br>

     These fields must be filled in before you can successfully submit the form.</font><p>
     <font face="Arial" size="2">Please use your browser's back button to return to the form and try again.</font></td></tr>
   </table>
  </center>
</td>
	</tr>
	<tr>
		...
		<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" id="obj1" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" border="0" width="150" height="400">
			<param name="movie" value="../../flash/barra.swf">
			<param name="quality" value="High">
			<embed src="../../flash/barra.swf" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" name="obj1" width="150" height="400" quality="High"></object>
		</td>
	</tr>
	<tr>
		<td width="962" colspan="3" height="64">
		<table border="0" width="100%" id="table3" cellspacing="0">
			<tr>
				<td width="175">&nbsp;</td>
				<td>
				<p align="center"><font size="2" color="#808080"><br>
				All paintings, art and illustrations within this website are 
				fully copyrighted and may not be reproduced, republished or 
				mirrored on another web page, website or printed material.<br>
&nbsp;Copyright 2009. De Jalón Fine Arts. All rights reserved.</font></td>
				<td width="265">&nbsp;</td>
			</tr>
		</table>
		</td>
